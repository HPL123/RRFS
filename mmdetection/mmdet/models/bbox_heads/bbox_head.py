...
class BBoxHead(nn.Module):
    ...
    def init_weights(self):
        if self.with_cls:
            # nn.init.normal_(self.fc_cls.fc1.weight, 0, 0.01)
            # nn.init.normal_(self.fc_cls.M.data, 0, 0.01)
            # nn.init.constant_(self.fc_cls.fc1.bias, 0)
    ...
    def get_det_bboxes(self,
        ...
        scores = cls_score#F.softmax(cls_score, dim=1) if cls_score is not None else None
