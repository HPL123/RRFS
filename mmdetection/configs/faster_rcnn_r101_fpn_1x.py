...
model = dict(
    type='FasterRCNN',
    pretrained='./pretrain_model/resnet101.pyth',
    backbone=dict(
        type='ResNet',
        depth=101,
        num_stages=4,
...
data_root = '/disk4/hpl/zreo_shot_object_detection/SUZ_zero_shot/datasets/VOC/COCO/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        # classes_to_load='MSCOCO/train_coco_seen_all.csv',
